...
# 3. ResNet-152 Model Definition
# This class is structured to follow the ResNet architecture described in the paper.
class Bottleneck(nn.Module):
    """
    The bottleneck residual block for ResNet-50 and deeper models.
    It uses a 3-layer shortcut connection.
    """
    expansion = 4
...
def ResNet152(num_classes=10):
    # For ResNet-152, we use the Bottleneck block with the configuration [3, 8, 36, 3]
    ...
    with open(RESULTS_FILE, 'w', newline='') as csvfile:
        ...
        for epoch in range(EPOCHS):
            ...
            if accuracy > best_accuracy:
                ...
                model_path = os.path.join(MODEL_SAVE_DIR, f'best_model_resnet152.pth')
