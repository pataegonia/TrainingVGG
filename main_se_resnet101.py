...
def SEResNet101(num_classes=10):
    # For SE-ResNet-101, we use the SEBottleneck block with the configuration [3, 4, 23, 3]
    # The key difference from ResNet-50 is the third layer has 23 blocks instead of 6
    return SEResNet(SEBottleneck, [3, 4, 23, 3], num_classes)

# 5. Initialize model, loss function, and optimizer as per the paper
model = SEResNet101(num_classes=NUM_CLASSES).to(DEVICE)
    ...
    with open(RESULTS_FILE, 'w', newline='') as csvfile:
        ...
        for epoch in range(EPOCHS):
            ...
            if accuracy > best_accuracy:
                ...
                model_path = os.path.join(MODEL_SAVE_DIR, f'best_model_se_resnet101.pth')
...
if __name__ == '__main__':
    train_model()
    print("Training and validation finished! Results saved to SENet101.csv.")