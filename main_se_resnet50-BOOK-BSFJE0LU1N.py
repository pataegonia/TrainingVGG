...
def SEResNet50(num_classes=10):
    # For SE-ResNet-50, we use the SEBottleneck block with the configuration [3, 4, 6, 3]
    ...
    with open(RESULTS_FILE, 'w', newline='') as csvfile:
        ...
        for epoch in range(EPOCHS):
            ...
            if accuracy > best_accuracy:
                ...
                model_path = os.path.join(MODEL_SAVE_DIR, f'best_model_se_resnet50.pth')
